...
class RegisterUser(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        user = get_user_model().objects.create(
            first_name=first_name, last_name=last_name, email=email, is_administrator=True
        )
        ...
        send_email.delay("send_activation_email", str(user), user.email, {"{activation_link}": activation_link})
...
class LoginUser(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        if user:
            ...
            return LoginUser(user=user, token=token, verification_message=verification_message)
        else:
...
class LogoutUser(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        logout(info.context)
        return LogoutUser(is_logged_out=True, verification_message='User successfully logged out!')
...
class ResetPassword(graphene.Mutation):
    ...
    def mutate(self, info, email):
        ...
        send_email.delay("reset_password_email", str(user), user.email, {"{password_reset_link}": password_reset_link})
...
class ResetPasswordConfirm(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        if check and user:
            user.set_password(password)
            user.save()
        return ResetPasswordConfirm(is_valid=False, verification_message="Password has been succesfully resetted.")
...
class CreateGroup(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        return CreateGroup(group=group, verification_message="Group is created successfully")
...
class UpdateGroup(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        return UpdateGroup(group=group, verification_message="Group is updated successfully")
...
class AddUserToGroup(graphene.Mutation):
    ...
    def mutate(self, info, user_id, group_id):
        ...
        return AddUserToGroup(user=user, group=group, verification_message="The user has been added to the group.")
